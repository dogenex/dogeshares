...
uint256 hashGenesisBlock("0x0ab2b35fd1be4dbfa716018ffba5f1e5021ff1ba892b3859d79228be9ab41e23");
...
const string strMessageMagic = "DogeShares Signed Message:\n";
...
{
    int64 nSubsidy = 0.00000000 * COIN;

    if(nHeight > 2)
    {
       nSubsidy = 0.00000000 * COIN;
        }
...
static const int64 nTargetTimespan = 10 * 60; // DogeShares: 10 minutes
static const int64 nTargetSpacing = 150; // DogeShares: 2.5 minutes blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal dogeshares miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DogeShares", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "DogeShares-www.dogenex.com";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392474879; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1332575;

        if (fTestNet)
        {
            block.nTime    = 1392474879;
            block.nNonce   = 1332575;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfc877b140f934d441a4a748ca622f48b5a0d494b49d9a00652f6ae7be1314821"));
